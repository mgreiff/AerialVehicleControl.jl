...
* @date June 2020
*******************************************************************************/
#ifndef __CONT_ATTITUDE_FSF_SO3_CONTINUOUS_H__
#define __CONT_ATTITUDE_FSF_SO3_CONTINUOUS_H__
...
* distances based on this information. The update is done using the continuous
* feedback law n SO(3).
*
...
#endif /* __CONT_ATTITUDE_FSF_SO3_CONTINUOUS_H__ */
