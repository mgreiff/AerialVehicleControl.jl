...
Tests for the matrix_subtraction() function
"""
...
function test_call_matrix_double_subtraction(Am, Bm, Cm)
    status = ccall((:matrix_double_subtraction, AerialVehicleControl.CONT_LIB_PATH),
        Cint,
    ...
    @testset "Good inputs" begin
        for m = 1:10
            for n = 1:10
                ...
                # Call
                status = test_call_matrix_double_subtraction(Am, Bm, Cm)
                # Test
